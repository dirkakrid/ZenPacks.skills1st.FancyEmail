...
class IFancyEmailActionContentInfo(IInfo):
    ...
    body_format = schema.Text(
        ...
        <b><u> <span style="text-transform: uppercase;  background-color: #1F497D; color: ${evt/sevColour}; font-size: 200%; font-family: sans-serif"> ${evt/SevString} Severity Incident at  ${evt/Site} &nbsp&nbsp Category: ${evt/Category}</span></u> </b>
